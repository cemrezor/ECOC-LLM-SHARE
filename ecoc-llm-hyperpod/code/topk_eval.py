...
checkpoint = torch.load('/fsx/ubuntu/ecoc-llm-env/checkpoints/yu-ecoc-minimal-training-gpt-15M-vocab-1000-random-490-epochs-1-epoch-1.bin', map_location=torch.device('cpu'))
